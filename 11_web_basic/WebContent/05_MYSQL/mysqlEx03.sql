...
INSERT INTO T_SHOPPING_GOODS VALUES(1 , "쉽게배우는 데이터통신" , "박기현" , 19000); # ok


INSERT INTO T_SHOPPING_GOODS VALUES("컴퓨터 활용 능력" , "이주희" , 38000);   	    # error (컬럼 개수 불일치)


INSERT INTO 
		T_SHOPPING_GOODS(GOODS_TITLE , GOODS_WRITER , GOODS_PRICE) 
VALUES
		("컴퓨터 활용 능력" , "이주희" , 38000);  # ok
       
       
INSERT INTO 
		T_SHOPPING_GOODS(GOODS_TITLE , GOODS_WRITER , GOODS_PRICE) 
VALUES
		("컴퓨터 활용 능력" , "이주희" , 25000);  # error (UNIQUE 제약 위반)
...
INSERT INTO T_STUDENT2 VALUES(4 , "빌게이츠" , "C4");    # KEY 참조 제약 위반 ( 메인키에 없는 데이터 )
INSERT INTO T_STUDENT2 VALUES(5 , "스티브잡스" , "C5");  # KEY 참조 제약 위반 ( 메인키에 없는 데이터 )
...
SET
		CLASS_ID = "C100"
WHERE
		CLASS_ID = "C1";	# 참조키가 있을경우 메인키의 값만 수정 불가

DELETE FROM
		T_CLASS2
WHERE
		CLASS_ID = "C2";    # 참조키가 있을경우 메인키의 값만 삭제 불가
...
INSERT INTO T_STUDENT3 VALUES(4 , "빌게이츠" , "C4");    # KEY 참조 제약 위반 ( 메인키에 없는 데이터 )
INSERT INTO T_STUDENT3 VALUES(5 , "스티브잡스" , "C5");  # KEY 참조 제약 위반 ( 메인키에 없는 데이터 )
